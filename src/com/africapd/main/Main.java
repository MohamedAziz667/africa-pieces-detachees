...
import com.africapd.dao.FactureDAO;
import com.africapd.dao.PieceDetacheeDAO;
import com.africapd.dao.VenteDAO;
import com.africapd.dao.FournisseurDAO;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // int ligneFournisseur = fournisseurDAO.ajouterFournisseur(nouveauFournisseur);

        // if (ligneFournisseur == 1) {
        //     System.out.println("fournisseur ajouté avec succès.");
        //     System.out.println("ID généré : " + nouveauFournisseur.getId());
        // } else {
        //     System.out.println("Échec de l'ajout du fournisseur.");
        //     return;
        // }
...
int ligneFacture = factureDAO.ajouterFacture(nouvelleFacture);

if (ligneFacture == 1) {
    System.out.println("Facture ajoutée avec succès.");
    System.out.println("ID généré : " + nouvelleFacture.getIdFacture());
} else {
